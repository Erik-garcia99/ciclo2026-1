...
typedef enum{
	...
	adc=0x2,
	pwm=0x3,
	enable_tmp = 0x8, //hbailitar el servicio de temporizar para prender el led
	set_tmp = 0x9, //estabecer la hora de prender el led
	down_tmp = 0xA, //establecer al hora de apagado del led 
	server = 0xf,
}resourse_t;
