...
//funcion que realiza la conexion con la API crea un socket internamente, solamnete para relizar la consulta, es para lo unico que funcionara este socket, entonces la funcion 
//de la practica 5 creo que funcionara de manera correcta e independindeo del socket que hace la conexion con el servidor en UABC 
