...
//tareas neceasaris 
//
void task_count_time(void *params); //esta tarea se encarga de llevar el conteo de los segundos que estan pasando entre el tiempo que llego la hora de prender y apagar hasta que llegue esa hora, esta tarea cuenta en segundos, por lo que los valores seran valores grandes entre millones y miles de millones 

HandleTask_t count_time; //handel para la tarea que cuenta el tempi, en el caso se cancelar se elimina la tarea 
