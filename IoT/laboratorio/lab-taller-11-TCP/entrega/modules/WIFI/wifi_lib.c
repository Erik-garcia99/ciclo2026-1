...
//     //asingamos el numero espacio de memoria que va a necestiar

//     ESP_SSID_WIFI = realloc(ESP_SSID_WIFI, strlen(SSID)+1);
//     ESP_PSWD_WIFI = realloc(ESP_PSWD_WIFI, strlen(PSDW)+1);

//     //ahora que ya modfiicamos el espacio es hora de asignael los nuevos valores 

//     //este va a copiar 
//     if (ESP_SSID_WIFI != NULL && ESP_PSWD_WIFI != NULL) {
//         // 3. AHORA SÍ: Copiamos el contenido hacia las variables globales
//         // strcpy automáticamente copia las letras y remata con el '\0'
//         strcpy(ESP_SSID_WIFI, SSID);
//         strcpy(ESP_PSWD_WIFI, PSDW);
//         //liberamos memoria 
//         return ESP_OK;
